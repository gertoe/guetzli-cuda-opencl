...
ifeq ($(config),release)
  ...
  INCLUDES += -I. -Ithird_party/butteraugli -Iclguetzli -I/opt/cuda/include -I/usr/lib/OpenCL/vendors/intel/include
  FORCE_INCLUDE +=
  ...
  LIBS += -lOpenCL -lcuda -lprofiler -lunwind -ltcmalloc
  LDDEPS +=
